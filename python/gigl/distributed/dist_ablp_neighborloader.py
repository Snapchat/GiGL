...
class DistABLPLoader(DistLoader):
    ...
    def _supervised_to_homogeneous(self, data: HeteroData) -> Data:
        ...
        """
        batch_size = data[DEFAULT_HOMOGENEOUS_NODE_TYPE].batch_size
        ...
        homogeneous_data.batch_size = batch_size
...
class DistRandomLoader(DistLoader):
    def __init__(
        self,
        dataset: DistLinkPredictionDataset,
        num_neighbors: Union[list[int], dict[EdgeType, list[int]]],
