...
### Changed
- Removed `GiGL/python` directory: all contained folders have been moved up to the `GiGL` root directory by @svij-sc in https://github.com/Snapchat/GiGL/pull/449
