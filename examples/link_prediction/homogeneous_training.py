...
class TrainingProcessArgs:
    ...
    Contains all configuration needed to run distributed training for homogeneous graph neural
...
def _run_example_training(
    ...
    Args:
        ...
        tensorboard_resource_name (Optional[str]): Vertex AI Tensorboard
            resource name (``projects/.../locations/.../tensorboards/<id>``).
            When set together with ``tensorboard_experiment_name``, the chief
            rank streams scalar metrics to Vertex AI Experiments.
