...
After registration, click the link displayed to access the lab (you might have to login with your registered email). Now you should be able to access the labs!
