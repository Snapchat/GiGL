...
object Component extends _root_.scalapb.GeneratedEnumCompanion[Component] {
  ...
  lazy val values = scala.collection.immutable.Seq(Component_Unknown, Component_Config_Validator, Component_Config_Populator, Component_Data_Preprocessor, Component_Subgraph_Sampler, Component_Split_Generator, Component_Trainer, Component_Inferencer)
