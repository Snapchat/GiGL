...
final case class InferencerResourceConfig(
    ...
    private[this] def __computeSerializedSize(): _root_.scala.Int = {
      ...
      if (inferencerConfig.vertexAiGraphStoreInferencerConfig.isDefined) {
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      inferencerConfig.vertexAiGraphStoreInferencerConfig.foreach { __v =>
        val __m = __v
    ...
    def getCustomInferencerConfig: snapchat.research.gbml.gigl_resource_config.CustomLauncherConfig = inferencerConfig.customInferencerConfig.getOrElse(snapchat.research.gbml.gigl_resource_config.CustomLauncherConfig.defaultInstance)
    def withCustomInferencerConfig(__v: snapchat.research.gbml.gigl_resource_config.CustomLauncherConfig): InferencerResourceConfig = copy(inferencerConfig = snapchat.research.gbml.gigl_resource_config.InferencerResourceConfig.InferencerConfig.CustomInferencerConfig(__v))
...
object InferencerResourceConfig extends scalapb.GeneratedMessageCompanion[snapchat.research.gbml.gigl_resource_config.InferencerResourceConfig] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): snapchat.research.gbml.gigl_resource_config.InferencerResourceConfig = {
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 42 =>
          __inferencerConfig = snapchat.research.gbml.gigl_resource_config.InferencerResourceConfig.InferencerConfig.CustomInferencerConfig(__inferencerConfig.customInferencerConfig.fold(_root_.scalapb.LiteParser.readMessage[snapchat.research.gbml.gigl_resource_config.CustomLauncherConfig](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case tag =>
  ...
  sealed trait InferencerConfig extends _root_.scalapb.GeneratedOneof {
    ...
    def customInferencerConfig: _root_.scala.Option[snapchat.research.gbml.gigl_resource_config.CustomLauncherConfig] = _root_.scala.None
  }
  object InferencerConfig {
    ...
    @SerialVersionUID(0L)
    final case class VertexAiGraphStoreInferencerConfig(value: snapchat.research.gbml.gigl_resource_config.VertexAiGraphStoreConfig) extends snapchat.research.gbml.gigl_resource_config.InferencerResourceConfig.InferencerConfig {
      type ValueType = snapchat.research.gbml.gigl_resource_config.VertexAiGraphStoreConfig
      override def isVertexAiGraphStoreInferencerConfig: _root_.scala.Boolean = true
    ...
    @SerialVersionUID(0L)
    final case class CustomInferencerConfig(value: snapchat.research.gbml.gigl_resource_config.CustomLauncherConfig) extends snapchat.research.gbml.gigl_resource_config.InferencerResourceConfig.InferencerConfig {
      ...
      override def customInferencerConfig: _root_.scala.Option[snapchat.research.gbml.gigl_resource_config.CustomLauncherConfig] = Some(value)
  ...
  implicit class InferencerResourceConfigLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, snapchat.research.gbml.gigl_resource_config.InferencerResourceConfig]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, snapchat.research.gbml.gigl_resource_config.InferencerResourceConfig](_l) {
    ...
    def customInferencerConfig: _root_.scalapb.lenses.Lens[UpperPB, snapchat.research.gbml.gigl_resource_config.CustomLauncherConfig] = field(_.getCustomInferencerConfig)((c_, f_) => c_.copy(inferencerConfig = snapchat.research.gbml.gigl_resource_config.InferencerResourceConfig.InferencerConfig.CustomInferencerConfig(f_)))
