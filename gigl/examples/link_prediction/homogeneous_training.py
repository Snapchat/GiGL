...
WORLD_SIZE=1 RANK=0 MASTER_ADDR="localhost" MASTER_PORT=20000 python -m gigl.examples.link_prediction.homogeneous_training --task_config_uri=<frozen_task_config_uri>
