...
final case class VertexAiResourceConfig(
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      {
        val __v = bootDiskSizeGb
        if (__v != 0) {
          _output__.writeUInt32(8, __v)
        }
      };
      reservationAffinity.foreach { __v =>
        val __m = __v
    ...
    def withBootDiskSizeGb(__v: _root_.scala.Int): VertexAiResourceConfig = copy(bootDiskSizeGb = __v)
...
object VertexAiResourceConfig extends scalapb.GeneratedMessageCompanion[snapchat.research.gbml.gigl_resource_config.VertexAiResourceConfig] {
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 9 => __out = snapchat.research.gbml.gigl_resource_config.VertexAiReservationAffinity
    }
    __out
  }
