...
class CountMinSketchTest(TestCase):
    def test_count(self):
        ...
        cms.add_torch_long_tensor(candidate_ids)  # ty: ignore[invalid-argument-type] TODO(ty-torch-tensor-specialization): fix ty Tensor vs FloatTensor/LongTensor specialization.
