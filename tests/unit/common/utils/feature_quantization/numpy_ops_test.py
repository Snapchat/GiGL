...
class NumpyFeatureQuantizationOpsTest(TestCase):
    def test_quantize_ndarray_single_bit_packs_full_byte(self) -> None:
        ...
        actual = quantize_ndarray(features, bits=1)
    ...
    def test_quantize_ndarray_two_bit_packs_full_byte_ascending_codes(self) -> None:
        ...
        actual = quantize_ndarray(features, bits=2, clip_min=0.0, clip_max=3.0)
    ...
    def test_quantize_ndarray_four_bit_packs_full_byte_ascending_codes(self) -> None:
        ...
        actual = quantize_ndarray(features, bits=4, clip_min=0.0, clip_max=15.0)
    ...
    def test_quantize_ndarray_eight_bit_stores_one_code_per_column(self) -> None:
        ...
        actual = quantize_ndarray(features, bits=8, clip_min=0.0, clip_max=255.0)
    ...
    def test_quantize_ndarray_requires_multi_bit_clip_bounds(self) -> None:
        with self.assertRaisesRegex(ValueError, "requires clip_min/clip_max"):
            quantize_ndarray(np.zeros((1, 1)), bits=2)
