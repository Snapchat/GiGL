...
run_cora_glt_udl_kfp_test: task_config_uris_str:="examples/link_prediction/configs/e2e_cora_udl_glt_task_config.yaml"
...
run_dblp_glt_kfp_test: task_config_uris_str:="examples/link_prediction/configs/e2e_dblp_glt_task_config.yaml"
